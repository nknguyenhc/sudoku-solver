...
class KillerSudoku(Sudoku):
    ...
    def __init__(self, board, domains=None, constraints=None, is_updated=False):
    ...
    def assign(self, cell, value):
        ...
        sudoku = KillerSudoku(board, domains=domains, constraints=constraints, is_updated=True)
